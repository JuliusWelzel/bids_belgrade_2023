...
::: {.column width="55%"}
::: {.fragment .fade-in}
![](pics/bids_dataset_req.png)
:::
::: {.fragment .fade-in}
![](pics/bids_dataset_rec.png)
:::
:::
:::
...
## 
<h2 class="r-fit-text">MOTION SPECIFIC DATA</h2>
...
<h2 class="r-fit-text">Thank you for listening carefully</h2>

![](pics/thanks.gif){fig-align="center"}
