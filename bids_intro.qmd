...
:::
::: {.fragment .fade-up}
>   Easy to follow **guidelines** for researchers to share their data (including conversion tools in FieldTrip, MNE, EEGLAB)
:::
::: {.fragment .fade-up}
>   Share data to validate pipelines (e.g. OpenNeuro, NEMAR)
:::
...
## BIDS Brain Imaging Data Structure: What is in it for the PIs{auto-animate="true"}
...
-   less work to organise datasets with all tools avaliable ([EEGLab](https://eeglab.org/tutorials/04_Import/BIDS.html), [FieldTrip](https://www.fieldtriptoolbox.org/getting_started/bids/), [MNE](https://mne.tools/mne-bids/stable/index.html))
:::
...
-   appreciate the effort of members to adopt BIDS
:::
